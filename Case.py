...
def main():
    ...
    turtle.right(135)
    triangle(-275, 210, 35, 2450 ** 0.5, '#ef66e9')
    turtle.left(45)
    triangle(-60, 245, 35, 2450 ** 0.5, '#ef66e9')
    turtle.right(135)
    triangle(287, 325, 35, 2450 ** 0.5, '#ef66e9')
    turtle.right(45)
    triangle(-375, -85, 35, 2450 ** 0.5, '#ef66e9')
    turtle.right(135)
    triangle(-20, -1, 85, 14450 ** 0.5, '#ef66e9')
    turtle.right(225)
    triangle(260, -135, 35, 2450 ** 0.5, '#ef66e9')
    turtle.left(45)
    ...
    turtle.left(45)
    triangle(-320, 140, 35, 2450 ** 0.5, '#a551e1')
    triangle(-60, 210, 35, 2450 ** 0.5, '#a551e1')
    turtle.left(135)
    triangle(255, 220, 35, 2450 ** 0.5, '#a551e1')
    turtle.right(90)
    triangle(-305, -130, 35, 2450 ** 0.5, '#a551e1')
    turtle.right(90)
    triangle(40, 60, 85, 14450 ** 0.5, '#a551e1')
    turtle.left(135)
    triangle(340, -100, 35, 2450 ** 0.5, '#a551e1')
    turtle.left(90)
